...
import { AlertTriangle, Ban, MessageSquareWarning } from "lucide-react";
...
export function SendWarningForm({ userId }: { userId: string }) {
    ...
    return (
        <div className="space-y-2">
            <h2 className="text-xl font-semibold tracking-tight flex items-center gap-2"><MessageSquareWarning /> Send Warning</h2>
            <p className="text-muted-foreground text-sm">Send a notification to the user that will appear on their dashboard.</p>
             <Card>
                <Form {...form}>
...
export function BlockServiceAccessForm({ userId, currentBlock }: { userId: string, currentBlock: any | null }) {
    ...
    if (currentBlock?.status) {
         return (
             <div className="space-y-2">
                <h2 className="text-xl font-semibold tracking-tight flex items-center gap-2"><Ban className="text-destructive"/> Service Access Blocked</h2>
                <p className="text-muted-foreground text-sm">This user's access to services is currently blocked.</p>
                <Card>
    ...
    return (
         <div className="space-y-2">
            <h2 className="text-xl font-semibold tracking-tight flex items-center gap-2"><Ban /> Block Service Access</h2>
            <p className="text-muted-foreground text-sm">Temporarily or permanently block the user from accessing any service after logging in.</p>
            <Card>
                <Form {...form}>
