            ...
            <div className="space-y-2">
                ...
                <Card>
                    <CardContent className="divide-y p-0">
                         <Link href="/manage/root/permission/create" className="flex items-center gap-4 py-4 px-4 rounded-t-lg transition-colors hover:bg-muted/50">
                         ...
                         <Link href="/manage/root/permission/bulk-import" className="flex items-center gap-4 py-4 px-4 rounded-b-lg transition-colors hover:bg-muted/50">
                                    ...
                                    permissions.map(perm => (
                                        <TableRow key={perm.id}>
                                            <TableCell className="align-top">
                                                 <Link href={`/manage/root/permission/${perm.id}`} className="font-semibold hover:underline">{perm.name}</Link>
