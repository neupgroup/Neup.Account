...
import { getPendingVerificationRequests, grantVerification, revokeVerification } from '@/actions/root/verifications';
        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex items-center justify-between">
                     <Link href={`/manage/root/accounts/${request.accountId}`} className="hover:underline">
                        {request.fullName}
                     </Link>
                </CardTitle>
